...
@CucumberOptions(features = "src/test/resources/features/First_landing_page/DegreeFinder.feature", // the	path of the feature files
	glue = {"stepdefinitions"},// the path of the step definition files
	plugin = {"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:"},// to generate different types of reporting 
